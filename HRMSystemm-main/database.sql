...
CREATE TABLE IF NOT EXISTS employee_documents (
  ...
  employee_id INT NOT NULL,
  document_type ENUM('sss','philhealth','pagibig','tin','valid_id','employment_contract') NOT NULL,
  file_name VARCHAR(255) NOT NULL,
  file_path VARCHAR(255) NOT NULL,
  mime_type VARCHAR(100) NOT NULL,
  verification_status ENUM('pending','verified','rejected') NOT NULL DEFAULT 'pending',
  contract_status ENUM('not_applicable','for_signing','signed','verified') NOT NULL DEFAULT 'not_applicable',
...
CREATE TABLE IF NOT EXISTS applicants (
  ...
  initial_interviewer_id INT NULL,
  initial_interviewed_at DATETIME NULL,
  initial_interview_result VARCHAR(20) NULL,
  final_interviewer_id INT NULL,
  final_interviewed_at DATETIME NULL,
  final_interview_result VARCHAR(20) NULL,
  ...
  pos_account_required TINYINT(1) NOT NULL DEFAULT 0,
  pos_account_created_at DATETIME NULL,
  created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
